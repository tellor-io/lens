...
describe("All tests", function () {
  ...
  it("Should return the last N submitted values", async function () {
    ...
    let val_ID2 = 22;
    let val_ID3 = 33;
    await tellor.connect(acc1).submitMiningSolution("", [5, 4, 3, 2, 1], [00, 00, val_ID3, val_ID2, val2]);
    await tellor.connect(acc2).submitMiningSolution("", [5, 4, 3, 2, 1], [00, 00, val_ID3, val_ID2, val2]);
    await tellor.connect(acc3).submitMiningSolution("", [5, 4, 3, 2, 1], [00, 00, val_ID3, val_ID2, val2]);
    await tellor.connect(acc4).submitMiningSolution("", [5, 4, 3, 2, 1], [00, 00, val_ID3, val_ID2, val2]);
    await tellor.connect(acc5).submitMiningSolution("", [5, 4, 3, 2, 1], [00, 00, val_ID3, val_ID2, val2]);
    ...
    expect(res.length).to.equal(dataIDs.length);
    ...
    expect(res[2].value).to.equal(val_ID2);
    expect(res[2].timestamp).to.equal(timeOfLastValue1);
